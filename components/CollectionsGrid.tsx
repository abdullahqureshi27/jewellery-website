...
const COLLECTIONS = [
  {
    ...
    category: 'rings',
    description: 'Certified D VVS1 Moissanite set in hallmarked 925 silver and gold vermeil.',
    imageUrl: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=800&q=80',
    count: '18 Signature Designs',
  },
  {
    title: 'Emerald & Ruby Pendants',
    category: 'pendants',
    description: 'Natural Colombian-grade and lab-created gems wrapped in diamond halos.',
    imageUrl: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=800&q=80',
    count: '12 Statement Necklaces',
  },
  {
    title: 'Fine Earrings & Studs',
    category: 'earrings',
    description: 'Teardrop cluster drops, baroque pearl florets, and timeless daily studs.',
  ...
  },
  {
    ...
    category: 'bridal',
    description: 'Mughal filigree chokers, jhumkas, and matha pattis for unforgettable days.',
