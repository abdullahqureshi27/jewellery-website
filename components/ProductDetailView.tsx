 ...
 * high-res gallery, specifications matrix, and direct WhatsApp booking.
 */

import { useState } from 'react';
import Image from 'next/image';
import Link from 'next/link';
import { Sparkles, ShieldCheck, ArrowLeft, MessageCircle, Gem, Award, Clock } from 'lucide-react';
...
export default function ProductDetailView({ product }: ProductDetailViewProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hello Aurelia Atelier! I would like to inquire about this piece from your showcase:\n\n*${product.title}*\nItem Code: ${product.itemCode}\nMetal: ${product.metal}\nGemstone: ${product.gemstone}\nPrice: ${product.priceOnRequest ? 'Price on Request' : formattedPrice}\n\nCould you assist with sizing, certificate verification, and order processing?`
  );
